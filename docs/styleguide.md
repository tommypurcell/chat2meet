...
- Bar: `flex items-end gap-2 border-t border-[var(--divider)] bg-[var(--bg-secondary)] px-3 py-2` (matches `SchedulingParticipantsBar`; avoid `--bg-primary` here in dark mode — it is pure black and reads as a harsh band under the chat column).
